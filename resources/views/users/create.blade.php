                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    @if($errors->has('username'))
                                        <span class="error text-primary" for="input-username">{{ $errors->first('username') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    @if($errors->has('password'))
                                        <span class="error text-primary" for="input-password">{{ $errors->first('password') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
